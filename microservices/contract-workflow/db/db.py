"""
SQLite helpers for contract workflow run persistence.
Follows the pattern established in microservices/procurementworkflow/db/db.py.
"""
...
def init_db() -> None:
    ...
    print("[DB] Contract schema initialised.")
